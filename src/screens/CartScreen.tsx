import { Button, ScrollView, StatusBar, StyleSheet, Text, ToastAndroid, TouchableOpacity, View } from 'react-native'
            ...
            <BottomSheetModalProvider>
                ...
                <View style={styles.CartScreenHeader}>
                    <View style={styles.CartScreenHeaderLeft}>
                        ...
                        <Text style={styles.CartScreenHeaderTitle}>{t("Cart")}</Text>
                    </View>
                </View>
                            ...
                            {cartItemList === (undefined) || cartItemList.length === 0 ?
                                <View style={styles.EmptyCartContainer}>
                                    <LottieView
                                        ...
                                        loop
                                    />
                                    <Text style={styles.EmptyCartText}>{t("Cart is Empty")}</Text>
                                </View>
                                ...
                                (
                                    <View style={styles.ListItemContainer}>
                                        ...
                                        <View style={styles.BillDetailsContainer}>
                                            <Text style={styles.BillDetailsHeading}>{t("Address Details")}</Text>
                                        ...
                                        {borderColor : COLORS.secondaryLightGreyHex}
                                                    ...
                                                    />
                                                    <Text style={[styles.AddressListItemText, { marginLeft: SPACING.space_10 }]}>{userLoginStatus ? t("Add new Address") : t("Login to add new Address")}</Text>
                                                </TouchableOpacity>
                                        ...
                                        <View style={styles.BillDetailsContainer}>
                                            <Text style={styles.BillDetailsHeading}>{t("Bill Details")}</Text>
                                            <View style={styles.BillDetailsTotalPriceContainer}>
                                                <Text style={styles.BillDetailsTotalPriceHeading}>{t("Product Amount")}</Text>
                                                <Text style={styles.BillDetailsTotalPrice}>{t("Rs.")} {totalCartPrice}</Text>
                                            </View>
                                            <View style={styles.BillDetailsTotalPriceContainer}>
                                        ...
                                        {Math.floor(totalCartPrice / 10) !== 0 &&
                                            <View style={{ marginBottom: SPACING.space_10 }}>
                                                <Text style={{ textAlign: "center", fontSize: FONTSIZE.size_16, color: COLORS.primaryLightGreyHex, fontFamily: FONTFAMILY.poppins_regular }}>{t("You will get")} {Math.floor(totalCartPrice / 10)} <Image style={{ height: 20, width: 35, }} source={require("../assets/reward_coin.png")} /> {t("coins")}</Text>
                                            </View>
                                        }
                                        ...
                                        <TouchableOpacity
                                            onPress={userLoginStatus === false ?
                                                ...
                                                () => {
                                                    if (selectedAddressName === '') {
                                                        ToastAndroid.show(t("Select Delivery Address"), ToastAndroid.SHORT)
                                                    } else {
                                            ...
                                            <Text style={styles.CheckOutButtonText}>{userLoginStatus ? t("Proceed to Checkout") : t("Login to Proceed")}</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity
                                            onPress={userLoginStatus === false ?
                                                async () => {
                                            ...
                                            <Text style={styles.CheckOutButtonText}>{userLoginStatus ? t("Buy in group and Save Money") : t("Login to buy in group")}</Text>
                                        </TouchableOpacity>
                                    </View>
                                )
                            }
