interface Spacing {
  ...
  export const COLORS: Color = {
    ...
    primaryGreenHex : "#245c28",
    primaryLightGreenHex : "#41c47c",
    secondaryLightGreenHex : "#d1e3da",
    ...
    primaryLightestGreyHex : '#e6e9eb',
    primaryWhiteHex: '#FFFFFF',
    secondaryWhiteHex : '#EDEEF0',
